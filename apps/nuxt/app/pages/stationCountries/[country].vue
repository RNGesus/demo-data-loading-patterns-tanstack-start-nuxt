...
const { data: stationPhotos } = await useFetch(
  `/api/stationCountries/stationPhotos/${country.value}`,
)
</script>
...
<template>
  <div class="prose max-w-full">
    ...
    <RailwayStationsPhotographers v-if="stationPhotos?.photographers" class="not-prose">
      <RailwayStationsPhotographer
        v-for="photographer in stationPhotos.photographers"
    ...
    <RailwayStationsPhotos v-if="stationPhotos" class="not-prose">
      <RailwayStationsPhoto
        v-for="photo in stationPhotos.photos"
        :key="photo.id"
        :photo="photo"
        :photo-base-url="stationPhotos.photoBaseUrl"
        :country="country"
      />
