  ...
  <div class="photos">
    <div v-for="photo in photos" :key="photo.id" class="photo-card">
      <figure class="photo-figure">
        <NuxtImg width="384" height="216" class="photo-img" loading="lazy" :src="photoBaseUrl + photo.path" :alt="`Photo of a train station in ${(route.params.country?.toString() ?? '').toUpperCase()} by ${photo.photographer}`" />
