  ...
  return (
    <div>
      <div role="alert" className="alert alert-warning alert-soft my-5 w-auto">
        <span>
          ⚠️ same page navigation does not work properly right now and will trigger a full page load
          or always does a page transition ⚠️
        </span>
      </div>
      <form
        onSubmit={(event) => {
      ...
      >
        <label className="input input-bordered flex items-center gap-2">
          ...
          <input type="search" name="q" defaultValue={search.q} className="grow" />
